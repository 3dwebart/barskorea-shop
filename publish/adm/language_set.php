...
<div class="tbl_head01 tbl_wrap">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td>
			<input type="text" name="lang_code[<?php echo $i ?>]" value="<?php echo $row['lang_code'] ?>">
		</td>
		<td>
			<input type="text" name="lang2_code[<?php echo $i ?>]" value="<?php echo $row['lang2_code'] ?>">
		</td>
		<td>
			<label for="text_<?php echo $i; ?>" class="sound_only">스킨</label>
			<input type="text" name="text[<?php echo $i ?>]" value="<?php echo $row['text'] ?>" id="text_<?php echo $i; ?>">
		</td>
		<td>
			<label for="use_<?php echo $i; ?>" class="sound_only">사용여부</label>
			<select name="use[<?php echo $row['use'] ?>]">
		...
		<td>
			...
			<input type="text" name="sort[<?php echo $i ?>]" value="<?php echo get_text($row['sort']) ?>" id="sort_<?php echo $i ?>" class="required tbl_input bo_subject full_input" size="10">
		</td>
	</tr>
	<?php
	}
...
<div class="btn_fixed_top">
	...
	<?php } ?>
	<?php if ($is_admin == 'super') { ?>
	<a href="./language_set_form.php" id="bo_add" class="btn_01 btn">언어 추가</a>
	<?php } ?>
</div>
