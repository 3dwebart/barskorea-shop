...
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/blog-style.css">', 0);
?>
<!-- BIGIN ::Breadcrumb -->
            ...
            <div class="col-12">
                <div class="breadcrumb-content">
                    <ul>
                        ...
                        <li class="active"><a href="<?php echo G5_BBS_URL.'/write.php?bo_table='.$bo_table; ?>"><?php echo $g5['title']; ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
	...
	<section id="bo_w">
		...
		<form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
			...
			<div class="btn_confirm write_div my-4">
				<a href="./board.php?bo_table=<?php echo $bo_table ?>" class="btn_cancel btn .btn_cancel">취소</a>
