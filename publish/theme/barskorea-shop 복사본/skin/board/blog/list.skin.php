		                ...
		                <div class="blog_area">
							<form name="fboardlist"  id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
								...
								<?php for ($i=0; $i<count($list); $i++) {
									...
									if($lang == 'kor') {
										$list_date = date("Y-m-d", strtotime($list[$i]['wr_datetime']));
									} else {
										$list_date = date("F d, Y", strtotime($list[$i]['wr_datetime']));
									}
								?>
								<article class="blog_single">
									<header class="entry-header">
	                                    ...
	                                    <span class="post-by"> Posts by : </span> <?php echo $list[$i]['mb_id']; ?> </span>
	                                ...
	                                <a class="comment" href="#">
	                                	<?php if ($list[$i]['comment_cnt']) { echo $list[$i]['wr_comment']; }?> comments
	                                </a>
	                                <!--start comment in post page -->
	                            </article>
	                            <?php } ?>
								<?php if (count($list) == 0) { echo "<article class=\"blog_single\">게시물이 없습니다.</article>"; } ?>
