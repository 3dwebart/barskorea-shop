...
function add_sel_option(type, id, option, price, stock) {
	...
	opt += "<div class=\"row-4\">";
	opt += "<div class=\"col-12 col-md-5 col-lg-4\">";
	opt += "<span class=\"sit_opt_subj\">"+option+"</span>";
	opt += "<span class=\"sit_opt_prc\">"+opt_prc+"</span>";
	opt += "</div>"; // } col-12 col-md-5 col-lg-4
	opt += "<div class=\"col-12 col-md-7 col-lg-8\">";
	opt += "<div class=\"input-group\">";
	opt += "<div class=\"input-group-prepend\">";
	opt += "<button type=\"button\" class=\"sit_qty_minus btn_frmline btn btn-warning\"><i class=\"fa fa-minus\"></i></button>";
	opt += "</div>"; // } input-group-prepend
	opt += "<input type=\"text\" name=\"ct_qty["+item_code+"][]\" value=\"1\" class=\"frm_input form-control\" size=\"5\">";
	opt += "<div class=\"input-group-prepend\">";
	opt += "<button type=\"button\" class=\"sit_qty_plus btn_frmline btn btn-primary\">증가</button>";
	opt += "</div>"; // } input-group-prepend
	opt += "<div class=\"input-group-prepend\">";
	opt += "<button type=\"button\" class=\"sit_opt_del btn_frmline btn btn-danger\">삭제</button>";
	opt += "</div>"; // } input-group-prepend
	opt += "</div>"; // } input-group
	opt += "</div>"; // } col-12 col-md-7 col-lg-8
	opt += "</div>"; // } row-4
	opt += "</li>";
...
function same_option_check(val) {
	...
	if(result) {
		alert(val+" 은(는) 이미 추가하신 옵션상품입니다. : " + result + " :: " + val);
	}
